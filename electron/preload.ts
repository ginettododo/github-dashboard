...
import type { AppSettings, CloneRequest, CloneResult, EnvironmentStatus, OperationLogEntry, RepoAction, RepoActionResult, RepoStatus } from '../src/shared/types';
...
const api = {
  ...
  getEnvironmentStatus: (): Promise<EnvironmentStatus> => ipcRenderer.invoke('env:get-status'),
